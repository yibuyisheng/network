...
this.seajs={_seajs:this.seajs};seajs.version="1.1.1-dev";seajs._data={config:{debug:"",preload:[]},memoizedMods:{},packageMods:[]};seajs._util={};seajs._fn={};
...
//config.js
window.ct = window.ct||{};
ct.host = "http://www.cutool.com";

seajs.config({
  base: "http://static.cutool.com/js/1.0.11/",
  map : [
	[ /^(.*\/js\/.*\.(?:css|js))(?:.*)$/i, '$1?20120601']
  ],
  alias: {
    'jquery': 'thirdparty/jquery',
	'jquery.ui':'thirdparty/jquery-ui-1.8.16.sortable.min',
	
	'utils':'lib/utils/utils',
	'stringFormat':'lib/utils/stringFormat',
	'timeFormat':'lib/utils/timeFormat',
	'cookie':'lib/utils/cookie',
	'timer':'lib/utils/jquery.timers',
	'bgiframe': 'lib/utils/bgiframe',
	
	'transitions':'lib/effect/transitions',
	'tabs': 'lib/effect/jqurey.tool.tabs',
	'jcrop': 'lib/effect/jquery.Jcrop',
	'masonry':'lib/effect/jquery.masonry',
	'lazyload':'lib/effect/jquery.lazyload',
	'scrollImages':'lib/effect/jqurey.scrollImages',

	'overlay': 'lib/overlay',
	'fancybox': 'lib/widget/fancybox/jquery.fancybox',
	
	'window': 'lib/window/window',
	'container': 'lib/window/container',
	'modalDialog': 'lib/window/modalDialog',
	
	'drag': 'lib/event/drag',
	'outer': 'lib/event/outer',
	
	'md5':'lib/auth/md5',

	'loginWindow':'modules/common/widgets/loginWindow',
	'confirm':'modules/common/widgets/confirm',
	'tips':'modules/common/widgets/tips',
	
	'feedback':'modules/common/widgets/feedback',

	'feedAjax':'modules/common/ajax/feedAjax',
	'comment':'modules/common/comment/comment',
	'forward':'modules/common/forward/forward',
	'vcard':'modules/common/vcard/vcard',
	'skin':'modules/user_center/skin'
  },
  debug: true,  
  charset: 'utf-8'
});